    ...
    <>
      ...
      <article className="bg-slate-950 min-h-screen py-12 lg:py-20 text-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Breadcrumbs */}
          <nav
            className="flex flex-wrap items-center gap-2 text-xs text-slate-400 mb-8"
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {locationData.subAreas.map((area, idx) => (
                    <span
                      key={idx}
                      className="text-[11px] px-2.5 py-1 rounded-md bg-slate-950 border border-slate-800 text-slate-300"
                    >
                      {area}
                    </span>
                  ))}
          ...
          <section className="my-14 bg-slate-900/60 border border-slate-800 rounded-3xl p-6 sm:p-8 space-y-4">
          ...
          <section className="my-16 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {locationData.commonProblems.map((prob, idx) => (
                <div
                  key={idx}
                  className="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-2"
                >
          ...
          <section className="my-16 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {CORE_SERVICES.map((s) => (
                ...
                >
                  <div>
                    <div className="text-sm font-bold group-hover:text-amber-400 transition-colors">
                      {s.name} in {cityName}
                    </div>
