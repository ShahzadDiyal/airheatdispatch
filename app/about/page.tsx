      ...
      <div className="bg-slate-50 min-h-screen py-12 lg:py-16 text-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-14">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 space-y-4 shadow-sm flex flex-col justify-between">
              <div>
              ...
              <div className="p-4 rounded-xl bg-slate-100 border border-slate-200 text-xs text-slate-700 space-y-2">
                <span className="font-bold text-slate-900 block">
                  24/7 Connection Hotline:
                </span>
                <a
                  href={`tel:${SITE_CONFIG.phoneRaw}`}
                  rel="dofollow"
                  className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-orange-500 hover:bg-orange-600 text-white font-bold text-xs transition-colors shadow-md"
                >
          ...
          {/* Mandated Disclaimer (Requirement 9) */}
          <div className="p-6 rounded-2xl bg-white border border-slate-200 text-xs text-slate-500 leading-relaxed my-12 shadow-sm">
            <strong className="text-slate-900 block mb-1">
              Required Homeowner Disclaimer:
            </strong>
