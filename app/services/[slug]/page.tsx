        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-16">
            ...
            <div className="lg:col-span-5 bg-slate-900 border border-slate-800 rounded-3xl p-8 space-y-6 shadow-2xl">
              ...
              <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 text-xs text-slate-300">
                ...
                Diagnostic inspection fee is waived 100% when you approve any recommended repair during our visit.
              </div>
            </div>
          </div>
          ...
          <section className="my-16 bg-slate-900/60 border border-slate-800 rounded-3xl p-8 space-y-6">
            ...
            <div className="text-sm text-slate-300 leading-relaxed space-y-4">
              <p>
                Heating and air conditioning systems operate on complex vapor-compression refrigeration cycles and thermodynamic heat transfer principles. When an HVAC unit suffers from reduced cooling capacity, short-cycling, or electrical strain, technicians perform systematic diagnostics targeting subcooling, superheat, static duct pressure, and electrical amperage draw.
              </p>
              <p>
                Maintaining optimal SEER2 (Seasonal Energy Efficiency Ratio) standards requires precise metering device calibration (TXV or fixed orifice), clean thermal evaporator coils, and leak-free copper refrigerant lines. Failure to address minor component wear—such as deteriorating dual-run capacitors or pitted magnetic contactors—frequently leads to total compressor motor burnouts during high summer heat loads.
              </p>
              <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                <div>
                  <span className="font-bold text-amber-400 block mb-1">Thermodynamic Health Check:</span>
                  Verifying subcooling & superheat against manufacturer specifications for R-410A / R-32 systems.
                </div>
                <div>
                  <span className="font-bold text-sky-400 block mb-1">Electrical Amp Draw Audit:</span>
                  Testing start/run capacitors, blower motor windings, and compressor LRA (Locked Rotor Amps).
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="my-16 bg-slate-900 border border-slate-800 rounded-3xl p-8 space-y-6">
            <h2 className="text-2xl font-bold text-white">Transparent Service Tier Comparison</h2>
            <p className="text-slate-300 text-sm">
              We operate on an upfront flat-rate pricing model. You review and sign off on the exact itemized quote before any work begins.
            </p>
              ...
              <table className="w-full text-left text-xs sm:text-sm text-slate-300">
                <thead className="bg-slate-950 text-white font-bold uppercase text-[11px] tracking-wider border-b border-slate-800">
                  <tr>
                    ...
                    <th className="p-4 text-amber-400">AirHeat Dispatch Quote Model</th>
                ...
                <tbody className="divide-y divide-slate-800">
                  <tr>
                    ...
                    <td className="p-4 font-bold text-emerald-400">100% Waived with Repair</td>
                    <td className="p-4 text-slate-300">Full 21-Point Inspection</td>
                  ...
                  <tr>
                    ...
                    <td className="p-4 font-bold text-amber-400">Upfront Flat-Rate Quote</td>
