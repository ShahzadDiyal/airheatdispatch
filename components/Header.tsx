        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-2">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              rel="dofollow"
              className="text-sky-400 hover:text-sky-300 font-bold transition-colors flex items-center gap-1"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-6 xl:gap-8">
            ...
            <div className="relative group py-2">
              <Link
                href="/services"
                rel="dofollow"
                className="text-sm font-semibold text-slate-200 hover:text-sky-400 transition-colors flex items-center gap-1"
              >
                Services
              ...
              {/* Dropdown menu */}
              <div className="absolute top-full left-0 w-80 bg-slate-900 border border-slate-800 rounded-xl shadow-2xl p-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-150 transform translate-y-2 group-hover:translate-y-0">
                {CORE_SERVICES.map((s) => (
                  <Link
                    key={s.slug}
                    href={`/services/${s.slug}`}
                    rel="dofollow"
                    className="block p-3 rounded-lg hover:bg-slate-800/80 transition-colors group/item"
                  >
                    <div className="text-sm font-bold text-slate-100 group-hover/item:text-sky-400 transition-colors">
                      {s.name}
                    </div>
          ...
          <div className="hidden lg:flex items-center gap-3 xl:gap-4">
            <a
              href={`tel:${SITE_CONFIG.phoneRaw}`}
              rel="dofollow"
              className="flex items-center gap-2 px-3.5 py-2.5 rounded-lg bg-slate-800 hover:bg-slate-750 border border-slate-700 text-white font-semibold text-xs xl:text-sm transition-all hover:scale-[1.02] shadow-sm shrink-0"
            >
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-lg bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-400 hover:to-blue-500 text-white font-bold text-xs xl:text-sm shadow-md shadow-sky-500/25 transition-all hover:scale-[1.02] active:scale-95 cursor-pointer shrink-0"
            >
              Schedule Online
            </button>
          </div>
          ...
          <div className="flex items-center gap-3 lg:hidden">
            <a
              href={`tel:${SITE_CONFIG.phoneRaw}`}
              rel="dofollow"
              className="p-2 rounded-lg bg-sky-500/10 text-sky-400 border border-sky-500/20"
              aria-label="Call HVAC Service"
            >
          ...
          <div className="lg:hidden bg-slate-900 border-b border-slate-800 px-4 pt-4 pb-6 space-y-4 animate-in slide-in-from-top duration-200">
            <div className="space-y-1">
              ...
              <Link
                ...
                rel="dofollow"
                onClick={() => setMobileMenuOpen(false)}
                className="block px-3 py-2 text-xs font-bold text-sky-400 uppercase tracking-wider hover:bg-slate-800"
              >
            ...
            <div className="pt-2 border-t border-slate-800 space-y-2">
              <a
                href={`tel:${SITE_CONFIG.phoneRaw}`}
                rel="dofollow"
                className="w-full flex items-center justify-center gap-2 py-3 rounded-lg bg-slate-800 text-white font-bold text-sm border border-slate-700"
              >
              ...
              <button
                ...
                className="w-full py-3 rounded-lg bg-sky-500 text-white font-bold text-sm text-center shadow-lg shadow-sky-500/20"
              >
